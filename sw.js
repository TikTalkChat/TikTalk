...
self.addEventListener('install', event => {
  event.waitUntil(
    caches.open(CACHE_NAME)
      .then(cache => {
        console.log('Cache khul gaya hai');
...
self.addEventListener('fetch', event => {
  // Yeh Monetag ke fetch requests ko nahi rokega, kyunki unka script pehle se chal raha hai.
  // Yeh sirf aapki app ki files ke liye kaam karega.
